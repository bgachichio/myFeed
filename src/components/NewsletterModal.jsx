...
export default function NewsletterModal({ onClose, onAdded }) {
  ...
  // ── Home screen ───────────────────────────────────────────────
  if (step === 'home') return (
    <Modal onClose={onClose} title="Newsletter Integration" subtitle="Bring your email newsletters into myFeed">
      ...
      <div className="p-5">
        ...
        {ktnStep === 1 && (
          <div>
            ...
            <p className="text-xs text-stone-500 dark:text-stone-400 mb-4">This is your personal inbox. Any newsletter sent to it will appear in myFeed.</p>
            <div className="flex gap-2 mb-4">
        ...
        {ktnStep === 2 && (
          <div>
            ...
            <p className="text-xs text-stone-500 dark:text-stone-400 mb-4">
              Go to the newsletter's website and subscribe using your unique email address above. The newsletter will start delivering to your myFeed automatically.
            </p>
