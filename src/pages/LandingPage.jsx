...
const steps = [
  ...
  { n: '03', title: 'Read, not search', desc: 'Open myFeed and everything important is already there, in order.' },
]
      ...
      <section className="pt-32 pb-24 px-5 max-w-6xl mx-auto">
        <div className="max-w-3xl">
          ...
          <p className="text-lg text-stone-500 max-w-xl mb-10 leading-relaxed">
            myFeed aggregates newsletters, blogs, X feeds, and RSS sources into a single, 
